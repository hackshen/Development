...
<meta name="description" content="<?php echo htmlspecialchars(urldecode($title)); ?>是一款全自动在线网页制作工具，使用huahuagongzi核心技术，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。" />
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con2.value='诗梦';
            con3.value='分享个人所思所想';
			con4.value='http://www.huahuagongzi.top';
			con5.value='123456';
			con6.value='公告：huahuagongzi是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
